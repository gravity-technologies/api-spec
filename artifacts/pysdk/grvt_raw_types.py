...
class WSECNToBrokerFeedDataV1:
    ...
    feed: ECNToBrokerFeed
    # The previous sequence number that determines the message order
    prev_sequence_number: str


@dataclass
class WSECNToBrokerFeedSelectorV1:
    """
