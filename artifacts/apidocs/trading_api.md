...
## Admin
### Trigger Vault Redemption
```
FULL ENDPOINT: full/v1/internal_trigger_vault_redemption
LITE ENDPOINT: lite/v1/internal_trigger_vault_redemption
```
...
=== "Try it out"
    ...
    === "DEV"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.dev.gravitymarkets.io/full/v1/internal_trigger_vault_redemption' \
        ...
        !!! example "JSONRPC Full"
            ...
            {
                "jsonrpc": "2.0",
                "method": "v1/internal_trigger_vault_redemption",
                "params": {
                    "main_account_id": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
                    "vault_id": "3477045127917224"
                },
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.dev.gravitymarkets.io/lite/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "ma": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
        ...
        !!! example "JSONRPC Lite"
            ...
            {
                "j": "2.0",
                "m": "v1/internal_trigger_vault_redemption",
                "p": {
                    "ma": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
                    "vi": "3477045127917224"
                },
    ...
    === "STAGING"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.staging.gravitymarkets.io/full/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "main_account_id": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.staging.gravitymarkets.io/lite/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "ma": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
    ...
    === "TESTNET"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.testnet.grvt.io/full/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "main_account_id": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.testnet.grvt.io/lite/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "ma": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
    ...
    === "PROD"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.grvt.io/full/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "main_account_id": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.grvt.io/lite/v1/internal_trigger_vault_redemption' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "ma": "0xc73c0c2538fd9b833d20933ccc88fdaa74fcb0d0",
...
### Vault Detail
```
FULL ENDPOINT: full/v1/vault_detail
LITE ENDPOINT: lite/v1/vault_detail
```

=== "Request"
    <section markdown="1" style="float: left; width: 70%; padding-right: 10px;">
    -8<- "docs/schemas/api_vault_detail_request.md"
    </section>
    <section markdown="1" style="float: right; width: 30%;">
    !!! question "Query"
        **Full Request**
...
=== "Response"
    <section markdown="1" style="float: left; width: 70%; padding-right: 10px;">
    -8<- "docs/schemas/api_vault_detail_response.md"
    </section>
    <section markdown="1" style="float: right; width: 30%;">
    !!! success
        **Full Response**
...
=== "Try it out"
    ...
    === "DEV"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.dev.gravitymarkets.io/full/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vault_id": "3477045127917224"
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.dev.gravitymarkets.io/lite/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vi": "3477045127917224"
    ...
    === "STAGING"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.staging.gravitymarkets.io/full/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vault_id": "3477045127917224"
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.staging.gravitymarkets.io/lite/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vi": "3477045127917224"
    ...
    === "TESTNET"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.testnet.grvt.io/full/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vault_id": "3477045127917224"
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.testnet.grvt.io/lite/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vi": "3477045127917224"
    ...
    === "PROD"
        ...
        !!! example "REST Full"
            ``` { .bash .copy }
            curl --location 'https://trades.grvt.io/full/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vault_id": "3477045127917224"
        ...
        !!! example "REST Lite"
            ``` { .bash .copy }
            curl --location 'https://trades.grvt.io/lite/v1/vault_detail' \
            --header "Cookie: $GRVT_COOKIE" \
            --header "X-Grvt-Account-Id: $GRVT_ACCOUNT_ID" \
            --data '{
                "vi": "3477045127917224"
