!!! info "[ApiVaultInvestRequest](/../../schemas/api_vault_invest_request)"
    ...
    |currency<br>`c` |Currency|True|The currency used for the investment (e.g., USDT, DAI).|
    |num_tokens<br>`nt` |string|True|The number of tokens to invest, in base units (e.g., 6 decimals for USDT).|
