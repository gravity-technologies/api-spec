!!! info "[ApiInterestPaymentHistoryResponse](/../../schemas/api_interest_payment_history_response)"
    |Name<br>`Lite`|Type|Required<br>`Default`| Description |
    |-|-|-|-|
    |result<br>`r` |[InterestPayment]|True|The interest payments matching the request|
