!!! info "[ApiGetAllCollateralAssetInfoResponse](/../../schemas/api_get_all_collateral_asset_info_response)"
    Response for the collateral asset info endpoint<br>

    |Name<br>`Lite`|Type|Required<br>`Default`| Description |
    |-|-|-|-|
    |assets<br>`a` |[ApiCollateralAssetInfo]|True|Collateral configuration for every collateral-eligible asset (CVR > 0)|
