!!! info "[ApiVaultBurnTokensRequest](/../../schemas/api_vault_burn_tokens_request)"
    ...
    |currency<br>`c` |Currency|True|The currency used for the burn (e.g., USDT, DAI).|
    |num_tokens<br>`nt` |string|True|The number of tokens to burn, in base units (e.g., 6 decimals for USDT).|
