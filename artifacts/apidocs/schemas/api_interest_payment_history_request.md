!!! info "[ApiInterestPaymentHistoryRequest](/../../schemas/api_interest_payment_history_request)"
    ...
    |cursor<br>`c1` |string|False<br>`''`|The cursor to indicate when to start the query from|
